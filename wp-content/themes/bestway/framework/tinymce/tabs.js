...
// triggers the thickbox
	...
	jQuery(function($){
		...
		<div class="mom_tiny_form">\
			...
			<ul class="mom_tabs">\
			    <li class="tab_title" data-href="#tab0"><div class="tab_sort_handle"></div><a href="#" class="mom_sc_select_icon tab_icon brankic-icon-info2"></a><input type="text" id="tab-title" placeholder="Title" value="Tab 1"><input class="tab-icon invisible" value=""><a class="remove_tab fa-remove" href="#"></a></li>\
			    <li class="tab_title" data-href="#tab1"><div class="tab_sort_handle"></div><a href="#" class="mom_sc_select_icon tab_icon brankic-icon-info2"></a><input type="text" id="tab-title" placeholder="Title" value="Tab 2"><input class="tab-icon invisible" value=""><a class="remove_tab fa-remove" href="#"></a></li>\
			    <li class="tab_title" data-href="#tab2"><div class="tab_sort_handle"></div><a href="#" class="mom_sc_select_icon tab_icon brankic-icon-info2"></a><input type="text" id="tab-title" placeholder="Title" value="Tab 3"><input class="tab-icon invisible" value=""><a class="remove_tab fa-remove" href="#"></a></li>\
			</ul>\
			<div class="tab_panes">\
...
<div id="TB_title"><div id="TB_ajaxWindowTitle">Select Icon</div><i class="icon_ov_close fa-remove"></i></div>\
		    <div class="ov_inner">\
		    <div class="mom_tiny_form_element">\
			<div class="mom_tiny_desc">\
			<div class="mom_td_bubble">\
