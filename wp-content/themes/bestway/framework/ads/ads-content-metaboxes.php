...
<div class="mom_meta_control">
	...
	<span class="ad-controler">
	    ...
	    <a href="#" class="dodelete delete-ad fa-close"></a>
	</span>
    </div>
   ...
   <?php $mb->the_field('ad_type'); ?>
        ...
        <div class="mom_tiny_input">
            ...
            <?php echo balanceTags($wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value(), 'type' => 'hidden', 'class' => 'mom_mb_image_imgID'))); ?>
            <?php echo balanceTags($wpalchemy_media_access->getButton(array('label'=> 'Upload'))); ?>
