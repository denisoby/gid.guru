...
class mom_ads_widget extends WP_Widget {
	function mom_ads_widget() {
		...
		$this->WP_Widget('momizatAds',__('Themelions - Ads','theme'),$widget_ops);
...
function form( $instance ) {
	...
	<p>
<label for="<?php echo esc_attr($this->get_field_id( 'ad' )); ?>"><?php _e('type', 'theme') ?></label>
<select id="<?php echo esc_attr($this->get_field_id( 'ad' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'ad' )); ?>" class="widefat">
	<?php
	...
	?>
		...
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $instance['tr'], 'on' ); ?> id="<?php echo esc_attr($this->get_field_id( 'tr' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'tr' )); ?>" />
			<label for="<?php echo esc_attr($this->get_field_id( 'tr' )); ?>"><?php _e('Transparent background', 'theme'); ?></label>
		</p>
<?php 
}
	} //end class