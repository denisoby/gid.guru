...
*/
				$(this).find('.mom-su-generator-select-color-value').wpColorPicker({
	...
	function parse() {
		...
		var query = $selected.val(),
			...
			single = $('#mom-su-generator .mom-su-generator-insert').data('type'),
			result = new String('');
			var content = $('#mom-su-generator-content').val();
			if (single == 'single') {
				content = 'false';
			}
		// Open shortcode
