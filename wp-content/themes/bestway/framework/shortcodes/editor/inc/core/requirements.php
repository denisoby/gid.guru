...
class mom_su_Requirements {
	...
	function __construct() {
		add_action( 'mom_su/activation', array( __CLASS__, 'php' ) );
		add_action( 'mom_su/activation', array( __CLASS__, 'wp' ) );
	}
