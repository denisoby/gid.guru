...
class mom_su_Generator_Views {
	...
	public static function color( $id, $field ) {
		$return = '<span class="mom-su-generator-select-color"><input type="text" name="' . $id . '" value="' . $field['default'] . '" id="mom-su-generator-attr-' . $id . '" class="mom-su-generator-attr mom-su-generator-select-color-value" /></span>';
		return $return;
	}
