...
class mom_su_Shortcodes {
	...
	public static function mom_su_private( $atts = null, $content = null ) {
		$atts = shortcode_atts( array( 'class' => '' ), $atts, 'private' );
		mom_su_query_asset( 'css', 'mom-su-other-shortcodes' );
		return ( current_user_can( 'publish_posts' ) ) ? '<div class="mom-su-private' . mom_su_ecssc( $atts ) . '"><div class="mom-su-private-shell">' . do_shortcode( $content ) . '</div></div>' : '';
	}
