...
[Shortcodes Ultimate](http://gndev.info/mom-shortcodes-ultimate/) is WordPress plugin that provides mega pack of shortcodes. This is really premium plugin that you can get absolutely for free!
...
= Premium Add-ons =
* __[Extra Shortcodes](http://gndev.info/mom-shortcodes-ultimate/extra/)__ - 15+ additional shortcodes
* __[Additional Skins](http://gndev.info/mom-shortcodes-ultimate/skins/)__ - 60+ additional skins for plugin shortcodes
* __[Shortcode Creator](http://gndev.info/mom-shortcodes-ultimate/maker/)__ - allows you to create your own custom shortcodes
...
* [Shortcodes Ultimate: Ultimatize your written content](http://wisdmlabs.com/blog/how-to-style-wordpress-themes-with-mom-shortcodes-ultimate/)
* [Add 40+ New Layout Features To WordPress with Shortcodes Ultimate](http://www.makeuseof.com/tag/add-40-new-layout-features-wordpress-mom-shortcodes-ultimate/)
* [Обзор плагина Shortcodes Ultimate](http://rad-dom.ru/mom-shortcodes-ultimate/) (Ru)
* [Shortcodes Ultimate Plugin Review](http://kevindankowebdesign.com/mom-shortcodes-ultimate-plugin-review/)
* [Shortcodes Ultimate — плагин неограниченных возможностей](http://altacademic.ru/mom-shortcodes-ultimate/) (Ru)
* [Shortcodes Ultimate – Free Shortcode Plugin For WordPress](http://www.wordpress-masterclass.com/mom-shortcodes-ultimate-free-shortcode-plugin-for-wordpress/)
* [Shortcodes Ultimate – Newest Update Broke My Website](http://4spotmarketing.com/mom-shortcodes-ultimate-stopped-working-and-the-update-broke-my-website/)
...
* [Support forum](http://wordpress.org/support/plugin/mom-shortcodes-ultimate/)
...
Resulted names will be:
  './wp-content/plugins/mom-shortcodes-ultimate/*'
...
[Visit support forum](http://wordpress.org/support/plugin/mom-shortcodes-ultimate/)
...
* Added: new option for tabs. You can now link any tab to any webpage [mom_su_tab url="http://" target="blank"]
...
* Fixed: lightbox and galleries scripts, [forum topic](http://wordpress.org/support/topic/carousel-mom-su-little-hack)
...
* New premium add-on - [Extra Shortcodes](http://gndev.info/mom-shortcodes-ultimate/extra/)
...
* New review - [Shortcodes Ultimate: Ultimatize your written content](http://wisdmlabs.com/blog/how-to-style-wordpress-themes-with-mom-shortcodes-ultimate/)
* New review - [Add 40+ New Layout Features To WordPress with Shortcodes Ultimate](http://www.makeuseof.com/tag/add-40-new-layout-features-wordpress-mom-shortcodes-ultimate/)
...
* Added classes mom_shortcodes_ultimate_Generator, mom_shortcodes_ultimate_Shortcodes and mom_shortcodes_ultimate_Data
...
= 4.1 =
* [5 metro skins](http://gndev.info/mom-shortcodes-ultimate/metro-skins/)
...
= 4.0 =
* [Official plugin page](http://gndev.info/mom-shortcodes-ultimate/)
* [Premium add-on for creating custom shortcodes](http://gndev.info/mom-shortcodes-ultimate/maker/)
* Plugin based on [Sunrise Plugin Framework](https://github.com/gndev/sunrise)
* [GitHub repo](https://github.com/gndev/mom-shortcodes-ultimate). Now you can easily fork and modify best plugin in the world (:
* Brand new Shortcode Generator, [demo video](http://www.youtube.com/watch?v=DR2c266yWEA)
* [Shortcodes API](http://gndev.info/kb/mom-shortcodes-ultimate-api-overview/)
