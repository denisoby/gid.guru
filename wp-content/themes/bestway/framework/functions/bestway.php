...
</svg><i class="fa-calendar-o svg-fallback"></i><?php echo mom_date_format(); ?></span>
...
<i class="fa-comment-o svg-fallback"></i><a href="<?php comments_link(); ?>"><?php comments_number(__('No Comments', 'theme') , __('1 Comment', 'theme'), __('% Comments', 'theme')); ?></a></span>
...
</svg><i class="steady-icon-user2 svg-fallback"></i><span class="fn"><?php _e('By : ', 'theme') ?><?php the_author_posts_link(); ?></span></span>
