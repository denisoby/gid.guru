...
*/		
		$this->WP_Widget('momizatSocialCounter',__('Themelions - Social Counter','theme'),$widget_ops);
                            ...
                            <ul>
                                <?php if ($rss_text != '') { ?>
                                    <li class="msc-item msc-rss">
                                        <a href="<?php echo esc_attr($rss_link); ?>"><div class="sc-head">
                                            <i class="bt-icon-rss"></i>
                                        </div>
                                        </a>
                                        <div class="sc-count">
                                            <span><?php echo esc_html($rss_text); ?></span>
...
function form( $instance ) {
	...
	<div class="mom_meta_note">
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'rss_text' )); ?>"><?php _e('rss number or text', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'rss_text' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'rss_text' )); ?>" value="<?php echo esc_attr($instance['rss_text']); ?>" class="widefat" />
		</p>

		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'rss_link' )); ?>"><?php _e('RSS Link (leave empty to use default rss link)', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'rss_link' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'rss_link' )); ?>" value="<?php echo esc_attr($instance['rss_link']); ?>" class="widefat" />
		</p>


		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php _e('Twitter Name', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php _e('facebook page ID (<a target="_blank" href="http://hellboundbloggers.com/2010/07/10/find-facebook-profile-and-page-id/">more Info</a>)', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'googlep' )); ?>"><?php _e('google+ ID', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'googlep' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'googlep' )); ?>" value="<?php echo esc_attr($instance['googlep']); ?>" class="widefat" />
		</p>

		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'dribbble' )); ?>"><?php _e('dribbble username', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'dribbble' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'dribbble' )); ?>" value="<?php echo esc_attr($instance['dribbble']); ?>" class="widefat" />
		</p>

		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'youtube' )); ?>"><?php _e('Youtub channel name', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'vimeo' )); ?>"><?php _e('Vimeo channel name', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php _e('pinterest full URL (Beta)', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'soundcloud' )); ?>"><?php _e('Soundcloud name', 'theme'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'behance' )); ?>"><?php _e('Behance username', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'behance' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'behance' )); ?>" value="<?php echo esc_attr($instance['behance']); ?>" class="widefat" />
		</p>

		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'delicious' )); ?>"><?php _e('Delicious username', 'theme'); ?></label>
		<input type="text" id="<?php echo esc_attr($this->get_field_id( 'delicious' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'delicious' )); ?>" value="<?php echo esc_attr($instance['delicious']); ?>" class="widefat" />
		</p>
