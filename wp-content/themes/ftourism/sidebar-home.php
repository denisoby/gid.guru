	...
	<div id="home-cols-inner">
		...
		<div class="col2a">
			...
			<?php if ( !dynamic_sidebar( 'homepage-column-1-widget-area' ) ) : ?>
						...
						<h2 class="sidebar-title">
							<?php _e('Home Col Widget 1', 'ftourism'); ?>
						</h2><!-- .sidebar-title -->
						...
						<div class="textwidget">
							<?php _e('This is first homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #1.', 'ftourism'); ?>
						</div><!-- .textwidget -->
		...
		<div class="col2b">
			<?php if ( !dynamic_sidebar( 'homepage-column-2-widget-area' ) ) : ?>
					...
					<h2 class="sidebar-title">
						<?php _e('Home Col Widget 2', 'ftourism'); ?>
					</h2><!-- .sidebar-title -->
					...
					<div class="textwidget">
						<?php _e('This is second homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #2.', 'ftourism'); ?>
					</div><!-- .textwidget -->
